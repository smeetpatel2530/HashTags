...
public class Tumblr extends AppCompatActivity {
    ...
    private String Tags = "#tumblr #tumblrlife #tumblrphoto #tumblrphotos #tumblrlove #tumblrpic #tumblrpics #tumblrposts #tumblrpost #perfect #tumblrpicture #tumblrpictures #tumblrthings #tumblrstuff #instatumblr #beautiful #love #tumblrgram";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.textView179);

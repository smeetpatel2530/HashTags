...
public class Baseball extends AppCompatActivity {
    ...
    private String Tags = "#baseball #base #ball #bases #homerun #bat #throw #catch #swing #photooftheday #field #pitcher #TFLers #mlb #firstbase #game #instagood #secondbase #thirdbase #inning #baseballbat #mitt #gloves #out #sport #sports";
    @Override

...
public class FireWork extends AppCompatActivity {
    ...
    private String Tags = " #fireworks #firework #tnt #light #noise #sky #night #dark #bright #holiday #instafireworks #fourthofjuly #celebrate #celebration #usa #glow #nighttime #firecrackers #smokebombs #cracklers #whistlers #independenceday";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fire_work);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("FireWork Tags");

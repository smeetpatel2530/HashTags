...
public class Brother extends AppCompatActivity {
    ...
    private String Tags = "#brother #brothers #brotherhood #brotherly #brotherfromanother #brotherlove #brothersister #brotherbear #brotherandsister #babybrother #brotherforlife #mybrother #brothersandsisters #bigbrother #mybrothers #stepbrothers \n";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brother);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Brother");

...
public class FastFood extends AppCompatActivity {
    ...
    private String Tags = "#fastfood #fastfood #kfc #chicken #mashhad #instafood #foodporn #fastfood #chips #yummy #delicious #breakfast  #realfastfood  #foodlover #beautiful #prettyfood";
    @Override

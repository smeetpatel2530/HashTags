...
public class Fall extends AppCompatActivity {
    ...
    private String Tags = "#fall #autumn #leaves #falltime #season #seasons #instafall #instagood #TFLers #instaautumn #photooftheday #leaf #foliage #colorful #orange #red #autumnweather #fallweather #nature";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fall);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Fall");

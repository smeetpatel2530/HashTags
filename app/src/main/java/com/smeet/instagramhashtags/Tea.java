...
public class Tea extends AppCompatActivity {
    ...
    private String Tags = "#tea #teatime #instatea #tealife #ilovetea #teaaddict #tealover #tealovers #teagram #healthy #drink #hot #mug #teaoftheday #teacup #teastagram #teaholic #tealove #tealife";
    @Override
